...
if __name__ == "__main__":
    ...
    parser.add_argument('--bag_path', type=str, help='path to bag', default="/media/xingchen24/xingchen/datasets/learn_based_planner/xiaoba/2023.12.21/2023-12-21-11-38-53_with_det.bag")
